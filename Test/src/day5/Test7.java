//Write a script to check two webElement are aligned horizontally or not.. (y coordinate same and x must be different)
package day5;
...
public class Test7 {
	...
	public static void main(String[] args) {
		...
		if (y1 == y2) {
			System.out.println("UN and PWD are aligned horizontally");
		} else {
			System.out.println("UN and PWD are NOT aligned horizontally");
